            ...
            <table class="journal_entry_table_view">
                ...
                try {
                    ...
                    while ($row_1 = $stmt_1->fetch()) {
                        ...
                        $pages = 1;
                        while ($row = $stmt->fetch()) {
                            ?><tr class="journal_entry_line_update_link hover_highlight" data-bind="journal_entry_line" data-table_id="<?php echo $row['transaction']; ?>"> 
